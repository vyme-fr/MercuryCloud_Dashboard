    ...
    .then(function (json) {
        ...
        <tr>
            ...
            <div class="flex align-items-center list-user-action">
                <a class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Modifier" href="/users/user-edit.html?id=${json.users[i].uuid}">
...
function delete_product(uuid) {
    deleteData(api_url + `users/${uuid}`).then(data => {
        if (data.error == false) {
