    ...
    .then(function (json) {
        ...
        <tr>
            ...
            <div class="flex align-items-center list-user-action">
                <a class="btn btn-sm btn-icon btn-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Modifier" href="/roles/role-edit.html?id=${json.roles[i].id}">
                ...
                <a class="btn btn-sm btn-icon btn-danger" onclick="delete_role('${json.roles[i].id}')" data-toggle="tooltip" data-placement="top" title="" data-original-title="Supprimer" href="#">
                    <span class="btn-inner">
                        <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                
...
function delete_role(id) {
    deleteData(api_url + `roles/${id}`, {}).then(data => {
        console.log(data)
        if (data.error == false) {
