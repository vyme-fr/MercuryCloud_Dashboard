...
const user_uuid = getCookie('uuid')
...
fetch(api_url, {
  ...
  .then(function (json) {
    ...
    <li class="nav-item">
      <a id="users-list" class="nav-link " href="/users/users-list.html">
          <i class="icon">
  ...
  <li class="nav-item">
     <a id="roles-list" class="nav-link " href="/roles/roles-list.html">
         <i class="icon">
 ...
 <li class="nav-item">
 <a id="services-list" class="nav-link " href="/services/services-list.html">
     <i class="icon">
  ...
  <li class="nav-item">
    ...
    <li class="nav-item">
        <a id="ptero-products-list" class="nav-link" href="/products/ptero-products-list.html">
            <i class="icon">
        ...
        <a id="proxmox-products-list" class="nav-link" href="/products/proxmox-products-list.html">
          <i class="icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                  <g>
                  <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
      ...
      if (window.location.href.includes("users-list.html")) {
        if (permissions_array.includes("LISTUSERS") || permissions_array.includes("ADMIN")) {
          ...
          window.location.replace("/errors/error403.html")
        }
      }
      ...
      if (json.code === 401 || json.code === 404) {
    ...
    console.error(error)
    if (error.toString().includes("innerHTML")) { console.warn(" [WARN] Inner error: " + error) } else { window.location.replace("/errors/error500.html") }
  })
